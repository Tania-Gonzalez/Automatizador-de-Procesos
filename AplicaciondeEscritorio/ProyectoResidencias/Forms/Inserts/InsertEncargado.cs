...
{
    public partial class InsertEncargado : Form
    {
        #region Variables
        private int ID;
        ...
        private void Validar()
        {
            ...
            else
            {
                ...
                using (var context = new Base_Servicio_PracticasEntities(CadenaConexion))
                {
                    ...
                    var a = new Encargado_Escuela()
                    {
                        Nombre1_Encargado = nombre1,
                        Nombre2_Encargado = nombre2,
                    ...
                    context.Encargado_Escuela.Add(a);
                    context.SaveChanges();
                    ID = a.ID_Encargado;
