...
{
    public partial class RegistroProcesoPrincipal : UserControl
    {
        #region Delegador
        ...
        public RegistroProcesoPrincipal()
        {
            InitializeComponent();
        }
        ...
        private void BtnInfoCompleta_Click(object sender, EventArgs e)
        {
            ...
            if (id != null)
            {
                using (var context = new Base_Servicio_PracticasEntities(cadenaconexion))
                {
                    ...
                    using (var a = new ProcesoPrincipal(cadenaconexion, id.GetValueOrDefault()))
                    {
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (id != null)
            {
                ...
                using (var a = new EliminarEntrega(cadenaconexion, id.GetValueOrDefault()))
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            if (id != null)
            {
                using (var context = new Base_Servicio_PracticasEntities(cadenaconexion))
                {
                    ...
                    using (var a = new EliminarReporte(cadenaconexion, id.GetValueOrDefault()))
