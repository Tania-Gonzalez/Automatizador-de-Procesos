...
{
    public partial class UCGeneradorEtiquetas : UserControl
    {
        #region Delegador
        ...
        private void LlenarTabla(int? a)
        {
            ...
            using (var context = new Base_Servicio_PracticasEntities(cadenaconexion))
            {
                ...
                if (a == 1)//sin etiqueta
                {
                    listabusqueda = listabusqueda.Where(f => f.Etiqueta.Contains("False"));
                    dataGridView1.DataSource = listabusqueda.ToList();
                }
        ...
        private void BtnPasar_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView2.Rows.Count>=28)
            {
                MessageBox.Show("No se puede pasar mas elementos a la lista de generar ya que se llego al tamaño maximo permitido(tamaño máximo permitido 28 etiquetas por archivo)", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                ...
                if (id != null)
                {
                    for (int i = dataGridView1.RowCount - 1; i >= 0; i--)
                    {
                        ...
                        if (id.ToString() == dataGridView1.Rows[i].Cells[0].Value.ToString())
                        {
                            ...
                            {
                                solicitudEtiquetaBindingSource.Add((SolicitudEtiqueta)fila.DataBoundItem);
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            if (dataGridView2.Rows.Count != 0)
            {
              solicitudEtiquetaBindingSource.RemoveAt(dataGridView2.CurrentRow.Index);
            }
        }
        ...
        private void BtnPasarTodo_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count != 0)
            {
                ...
                {
                    MessageBox.Show("No se puede pasar toda la lista de busqueda ya que excede el tamaño máximo permitido(tamaño máximo permitido 28 etiquetas por archivo)","Alerta",MessageBoxButtons.OK,MessageBoxIcon.Warning);
        ...
        private void BtnLimpiar_Click(object sender, EventArgs e)
        {
            if (dataGridView2.Rows.Count != 0)
            {
                solicitudEtiquetaBindingSource.Clear();
            }
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            if (dataGridView2.Rows.Count != 0)
            {
                ...
                using (var a = new Etiquetas(cadenaconexion, ListaSolicitar))
                {
