...
{
    public partial class UCCartaAceptacion : UserControl
    {
        #region Delegador
        ...
        private void LlenarTabla(int? a)
        {
            ...
            using (var context = new Base_Servicio_PracticasEntities(cadenaconexion))
            {
                ...
                if (a==null)
                {
                    ...
                    {
                        listabusqueda = listabusqueda.Where(f => f.FolioAcept.Contains(TextFolio.Text)&&!string.IsNullOrEmpty(f.FolioAcept));
                        dataGridView1.DataSource = listabusqueda.ToList();
                    }

                    if (!string.IsNullOrEmpty(TextEscuela.Text))
                    {
                        listabusqueda = listabusqueda.Where(n => n.Escuela.Contains(TextEscuela.Text.Trim()) && !string.IsNullOrEmpty(n.FolioAcept));
                        dataGridView1.DataSource = listabusqueda.ToList();
                    }
                    if (!string.IsNullOrEmpty(TextNombre.Text))
                    {
                        listabusqueda = listabusqueda.Where(n => n.Nombre.Contains(TextNombre.Text.Trim()) && !string.IsNullOrEmpty(n.FolioAcept));
                        dataGridView1.DataSource = listabusqueda.ToList();
                    }
                ...
                if (a==1)
                {
                    listabusqueda = listabusqueda.Where(n => !string.IsNullOrEmpty(n.FolioAcept));
                    dataGridView1.DataSource = listabusqueda.ToList();
                }
        ...
        private void BtnFoliosAcept_Click(object sender, EventArgs e)
        {
            LlenarTabla(1);
        }
