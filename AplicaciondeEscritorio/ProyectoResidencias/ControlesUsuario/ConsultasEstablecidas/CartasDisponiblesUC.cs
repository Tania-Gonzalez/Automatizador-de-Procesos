...
{
    public partial class CartasDisponiblesUC : UserControl
    {
        private string cadenaconexion;
        public CartasDisponiblesUC()
        {
            InitializeComponent();
        }
        ...
        public void Cargar()
        {
            using (var context = new Base_Servicio_PracticasEntities(cadenaconexion))
            {
                var queryacept = (from e in context.Estudiante
                             ...
                             where (av.Estado == true && av.Peticion_Carta_Aceptacion == 2 && av.Carta_Aceptacion == false)
                ...
                var queryter = (from e in context.Estudiante
                                ...
                                join dp in context.Datos_Personales on e.ID_Datos_Personales equals dp.ID_Datos_Personales
                                join av in context.Avance on pg.ID_Programa equals av.ID_Avance
                                where (av.Estado == true && av.Peticion_Carta_Terminacion == 2 && av.Carta_Terminacion == false)
