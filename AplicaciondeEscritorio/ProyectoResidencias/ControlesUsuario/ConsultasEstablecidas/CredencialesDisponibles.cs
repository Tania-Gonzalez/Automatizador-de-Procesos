...
{
    public partial class CredencialesDisponibles : UserControl
    {
        private string cadenaconexion;
        public CredencialesDisponibles()
        {
            InitializeComponent();
        }
        ...
        public void Cargar()
        {
            using (var context = new Base_Servicio_PracticasEntities(cadenaconexion))
            {
                var query = (from e in context.Estudiante
                             ...
                             where (av.Estado == true && av.Peticion_Credencial == 2 && av.Credencial == false)
